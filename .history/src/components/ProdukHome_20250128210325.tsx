...
const ProductList: React.FC = () => {
  return (
    ...
    <div className="flex w-full justify-center items-center bg-red-400">
    <h1 className=" bg-blue-900 w-4xl text-black text-2xl font-bold mb-6">Headphones For You!</h1>
    </div>
