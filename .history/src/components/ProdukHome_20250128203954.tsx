...
const ProductCard: React.FC<{ product: Product }> = ({ product }) => {
  return (
    <div className="bg-white rounded-lg shadow-md">
      ...
      <button className="mt-3 bg-green-600 text-white px-1 py-1 rounded-lg w-28 hover:bg-green-700">
        Add to Cart
      </button>
      </div>
...
const ProductList: React.FC = () => {
  return (
    <div>
    <h1 className="bg-black text-center text-white text-2xl font-bold mb-6">Headphones For You!</h1>
