...
const ProductList: React.FC = () => {
  ...
  return (
    <div className="h-screen">
      <div className="flex w-full bg-red-200 justify-center items-center">
        <h1 className="text-black w-7xl bg-amber-400 text-2xl font-bold mb-6">Our Product For You!</h1>
      </div>

      <div className="p-6 flex justify-center items-center bg-white">
        <div className="grid grid-cols-1 sm:grid-cols-2 bg-amber-200 w-7xl md:grid-cols-4 gap-6">
          {currentProducts.map((product: Product) => (
            <div
              key={product.id}
              className="bg-white rounded-lg hover:shadow-md cursor-pointer"
