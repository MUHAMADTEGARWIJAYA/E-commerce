    ...
    <div className="p-6 grid md:grid-cols-2 gap-6">
      ...
      <div className="space-y-10 py-10 px-10">
        ...
        <div className="flex gap-4 mt-4">
          <button className="bg-white text-green-700 font-bold border px-6 py-3 rounded-3xl w-44 hover:bg-green-700 border-green-600 hover:text-white">Buy Now</button>
