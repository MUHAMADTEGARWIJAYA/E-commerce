...
const ProductDetail: React.FC = () => {
  ...
  {/* sidekanan */}
      <div className="space-y-10 py-10 px-10">
        ...
        <p className="text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam repudiandae cum asperiores provident deserunt, accusamus quisquam facere expedita sit fuga, fugiat velit unde! Reiciendis, dolorum quidem nostrum iusto ducimus fugiat!A perfect balance of high-fidelity audio and effortless magic.</p>
