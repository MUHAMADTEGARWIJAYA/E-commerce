...
const Footer: React.FC = () => {
  return (
    <footer className="bg-white text-black border py-10">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 sm:grid-cols-2 gap-6">
          {/* Logo & Deskripsi */}
          <div>
            <h2 className="text-2xl font-bold text-green-500">Inovasi Media Group</h2>
            <p className="text-gray-400 mt-2">
              Temukan produk terbaik dengan harga terjangkau hanya di Inovasi media Group!
            </p>
          </div>
